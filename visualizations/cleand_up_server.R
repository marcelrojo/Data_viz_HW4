...
function(input, output, session) { 
  ...
  voting_format_description <- reactive({
    ...
    if (year1 == "1975"){
      ...
      description <- "Between 2016 and 2024, the number of participating countries ranged from 37 to 43. 
                      The points awarded were a combination of jury points and televotes. 
                      Consequently, each country assigned points to their top 10 performances as follows:\n
                      1st place: 12 points (from both jury and televote)\n
                      2nd place: 10 points (from both jury and televote)\n
                      3rd to 10th place: 8 to 1 point (from both jury and televote)\n
                      For example, if Poland received 7 points (4th place) from the Portuguese jury and 10 points (2nd place) from the Portuguese televote, Poland would be awarded a total of 17 points from Portugal."
    }
    description
  })
